...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    en: [
      ...
      "💬 SOCIAL: your private conversations, recovered. EVE writes a log of every private chat and then never lets you reread them. Koru does: the new section under Character rebuilds your conversation history —possibly years of it— grouped by person, chat-style: theirs on the left, yours on the right, each person with a stable colour and portrait, every line timestamped as the game wrote it. Read-only, on purpose. And genuinely private: everything stays on your computer.",
