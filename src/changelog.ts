...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    es: [
      ...
      "🇨🇳 Y las naves cantadas en otro idioma ya se ven. Si en tu canal hay gente con el cliente en chino, cuando cantaban un Sabre la línea llegaba sin nave: Koru solo conocía los nombres en inglés, así que se le caía por el camino. Un interdictor invisible, que es justo la nave que te impide saltar. Ahora el catálogo trae los 421 nombres de nave en chino sacados de los datos del juego, y no se acepta ninguno que pudiera confundirse con un sistema o con otra nave.",
    ...
    en: [
      ...
      "🇨🇳 And ships called out in another language now show up. If someone in your channel runs the client in Chinese, a Sabre they reported arrived with no ship at all: Koru only knew the English names, so it fell through. An invisible interdictor — the very ship that stops you jumping. The catalogue now carries all 421 Chinese ship names taken from the game's own data, and none is accepted if it could be mistaken for a system or another ship.",
