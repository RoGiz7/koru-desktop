...
const EN: Record<string, string> = {
  ...
  // Retos del mes nuevos (2026-09-16). ⚠️ Estas etiquetas viajan por `tr(ui.label)`, que es una
  ...
  "Valoración DED": "DED rating",
  Cadena: "Chain",
  Modalidad: "Mode",
  propia: "your own",
  suya: "theirs",
  "Coste de entrada": "Entry cost",
  "Nota del botín": "Loot note",
  Comprador: "Buyer",
  "Lista de acceso": "Access list",
  Apuntada: "Noted",
  Caducaba: "Expired at",
  Cerrada: "Closed",
  "No se registró ninguna run: de esta escalación solo queda lo apuntado arriba.":
    "No run was recorded: all that's left of this escalation is what's noted above.",
  // --- Escalaciones: la gráfica de ISK generado por días (ver `escalacionesIsk.ts`) ---
  "ISK generado": "ISK generated",
  "Botín (las que corriste)": "Loot (the ones you ran)",
  "Ventas (las que vendiste)": "Sales (the ones you sold)",
  "Naves perdidas": "Ships lost",
  Ventas: "Sales",
  "Cada día cuenta cuando entró el ISK: el botín el día que cerraste la run, la venta el día que cobraste. Las naves perdidas van aparte y no se restan del botín, para que se vea de qué fue la diferencia.":
    "Each day counts when the ISK came in: loot on the day you closed the run, a sale on the day you got paid. Ships lost are kept separate and not subtracted from loot, so you can see what made the difference.",
  ...
  "Cada segmento es una medalla, teñida por su nivel. Pulsa uno para ver su evolución":
    "Each segment is one medal, tinted by its level. Click one to see how it grew.",
  ...
  "Le diste": "You gave",
  "Te dio": "They gave you",
  "HP que TÚ le reparaste": "HP YOU repaired on them",
  "HP que te reparó a TI": "HP they repaired on YOU",
  "cantado en el intel, en un sistema donde estaba la flota":
    "called on intel, in a system where the fleet was",
  "Reproducir en el mapa": "Play on the map",
  "Aún no ha pasado nada.": "Nothing has happened yet.",
  Velocidad: "Speed",
  Op: "Op",
  "Mando de flota": "Fleet command",
  // Bitácora — dominio «Mando» (las tarjetas FC, del grabador de ops)
  "Mando": "Command",
  "Primera silla": "First chair",
  "Ops de flota grabadas al mando": "Fleet ops recorded in command",
  "Al mando": "In command",
  "Horas acumuladas mandando una flota grabada": "Hours accumulated commanding a recorded fleet",
  "Pastor de gatos": "Cat herder",
  ...
  "Desclavar": "Unpin",
  "Partes": "Parts",
  "Partes hechas": "Parts done",
  "Añadir una parte…": "Add a part…",
  "Añadir": "Add",
  "Nueva nota": "New note",
  "¿Qué hay que recordar o hacer?": "What needs remembering or doing?",
  "Al guardar se abre la nota para ponerle pilotos o un aviso.":
    "On saving, the note opens so you can add pilots or an alert.",
  "Abrir la nota": "Open the note",
  "Destacada": "Pinned",
  ...
  "Más presión encajada": "Most pressure absorbed",
  Dadas: "Given",
  Recibidas: "Received",
  ...
  Ala: "Wing",
  Escuadra: "Squad",
  // Contratos (Comercio → Contratos). `comercio.tsx` traduce ANTES los valores crudos de ESI
  // (`item_exchange`, `finished`) a castellano; aquí solo van del castellano al inglés, como
  // cualquier otro texto de la app. Una sola cadena por concepto.
  ...
  Borrado: "Deleted",
  Emisor: "Issuer",
  "Cuánto le pedimos a EVE": "How much we're asking of EVE",
  "Peticiones que salen de verdad y lo que cuestan, para saber si Koru está apretando de más.":
    "Requests that actually go out and what they cost, so you can tell whether Koru is pushing too hard.",
  "fichas por ventana de 15 min": "tokens per 15-minute window",
  "min en marcha": "min running",
  "servidas por la caché de Koru (no salieron)": "served by Koru's cache (never left)",
  "respuestas con datos nuevos": "responses carrying new data",
  "«no ha cambiado» (ETag)": "«not modified» (ETag)",
  "errores 4xx": "4xx errors",
  "errores 5xx": "5xx errors",
  "fichas gastadas en total": "tokens spent in total",
  ...
  PERSONAS: "PEOPLE",
  "ISK RECIBIDOS": "ISK RECEIVED",
  "m³ MOVIDOS": "m³ MOVED",
  "pendientes de aceptar o en curso": "waiting to be accepted, or under way",
  "Ninguno abierto ahora mismo.": "None open right now.",
  ACTIVOS: "ACTIVE",
  "EN EL LIBRO": "IN THE LEDGER",
  NUEVOS: "NEW",
  "Sin título": "Untitled",
  "caduca en": "expires in",
  caducado: "expired",
  "Lo que te juegas": "What you're risking",
  "Contratos que habéis cruzado": "Contracts between you two",
  "contratos con esta persona": "contracts with this person",
  Contenido: "Contents",
  Recibes: "You receive",
  "Entregas a cambio": "You hand over",
  "Este contrato no lleva objetos.": "This contract carries no items.",
  "Leyendo el contenido…": "Reading the contents…",
  "No se pudo leer el contenido:": "Couldn't read the contents:",
  copia: "copy",
  "Recompensa por llevarlo": "Reward for hauling it",
  "Precio del intercambio": "Exchange price",
  Título: "Title",
  ...
  "No hay contratos guardados. EVE solo deja consultar los de los últimos 30 días: Koru los va guardando en cada sincronización, así que esta lista crecerá aunque EVE los olvide.":
    "No contracts stored yet. EVE only lets you query the last 30 days: Koru saves them on every sync, so this list will grow even after EVE forgets them.",
  "Los sistemas salen de las ubicaciones que Koru ya ha resuelto; las que nunca ha visto salen como «—». Un courier de un contrato ajeno puede no tener ruta hasta que lo aceptes.":
    "Systems come from locations Koru has already resolved; ones it has never seen show as «—». A courier contract from someone else may have no route until you accept it.",
  CONTRATOS: "CONTRACTS",
  "EN CURSO": "IN PROGRESS",
  COURIER: "COURIER",
  // «Ruta» y «Recompensa» ya existen más arriba (mapa y trabajos por libre): la traducción es
  // global por clave, así que aquí no se repiten.
  Volumen: "Volume",
  Fianza: "Collateral",
  Emitido: "Issued",
  Aceptó: "Accepted by",
  Entrega: "Delivery",
  "Koru guarda contratos desde": "Koru has been storing contracts since",
  "Lo anterior no es que no existiera: es que aún no lo miraba.":
    "Anything before that didn't fail to happen — Koru just wasn't looking yet.",
  "El ISK/m³ sale de la misma cuenta que hace el juego en la ventana del contrato. Lo que aquí añade Koru no es la cifra: es tenerla de TODOS tus contratos juntos y más allá de los 30 días que EVE recuerda.":
    "ISK/m³ is the same figure the game shows in the contract window. What Koru adds isn't the number: it's having it for ALL your contracts at once, and beyond the 30 days EVE remembers.",
  "al completarte un contrato": "when they complete a contract for you",
  "Koru ve que se completó el contrato, no lo que llevaba dentro":
    "Koru sees that the contract was completed, not what was inside it",
  ...
  corregir: "correct it",
  editar: "edit",
  // Cazador → modo Sistemas (2026-09-19)
  Hostiles: "Hostiles",
  hostiles: "hostiles",
  ...
  "No se pudo leer el sistema.": "Could not read the system.",
  "Nada cantado en este sistema en ese periodo. Eso no dice que esté tranquilo: dice que nadie de tus canales lo ha reportado.":
    "Nothing called in this system in that period. That does not mean it is quiet: it means nobody in your channels reported it.",
  "Hostiles distintos": "Distinct hostiles",
  "Primero del periodo": "First in period",
  "Solo lo que se ha cantado en tus canales de intel en ese periodo. Un hueco es que nadie lo reportó, no que no hubiera nadie.":
    "Only what was called in your intel channels in that period. A gap means nobody reported it, not that nobody was there.",
  "Días de la semana": "Days of the week",
  "Cuándo (día de la semana × hora UTC)": "When (day of week × UTC hour)",
  "en la ventana": "in the window",
  "semana del": "week of",
  "filtrar por esta hora": "filter by this hour",
  "filtrar por este día": "filter by this day",
  "pincha una celda, un día o una hora para filtrar": "click a cell, a day or an hour to filter",
  "quitar filtro": "clear filter",
  "Nadie con esa selección.": "Nobody in that selection.",
  "Nada con esa selección.": "Nothing in that selection.",
  "Por dónde pasa": "Where they pass through",
  "Abrir la ficha del sistema": "Open the system card",
  "avistamientos en la ventana": "sightings in the window",
  ...
  "El ×N compara los últimos 7 días con la media semanal del periodo elegido. Más de 1 = más movido que de costumbre en esa ventana.":
    "The ×N compares the last 7 days with the weekly average of the chosen period. Above 1 = busier than usual within that window.",
  "Alrededor · a 1 salto": "Around · 1 jump",
  "A 2 saltos": "2 jumps",
  "Se enseñan los 20 con más actividad de": "Showing the 20 most active of",
  "Las cifras de alrededor son de la misma ventana que la lista. Una raya es que nadie lo cantó, no que estuviera vacío.":
    "The figures around are from the same window as the list. A dash means nobody called it, not that it was empty.",
  "Se enseñan los 20.000 más recientes: antes de esa fecha no es que no hubiera nada, es que no se está mirando.":
    "Showing the 20,000 most recent: before that date it is not that nothing happened, it is that it is not being looked at.",
  "En el tiempo": "Over time",
  "Quién pasa por aquí": "Who passes through here",
  "Abrir su ficha": "Open their card",
