...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_loyalty_offers,
            commands::get_freelance_jobs,
            commands::get_freelance_board,
            ...
            commands::sov_upgrades_list,
            commands::sov_upgrades_replace,
            commands::sov_upgrades_clear,
            ...
            commands::intel_existentes,
            commands::intel_alias_set,
            commands::intel_alias_list,
            commands::intel_alias_remove,
            commands::get_intel_systems,
            commands::get_system_sightings,
            commands::get_pilot_sightings,
            commands::intel_record_lines,
            commands::intel_import_historico,
