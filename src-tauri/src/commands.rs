...
// ⚠️ AQUÍ HUBO UN COLAPSO DE AVISOS REPETIDOS Y SE QUITÓ A PROPÓSITO (2026-09-02).
//
// Lo puse para juntar en una sola alarma dos reportes del mismo sistema con segundos de
// diferencia. **RoGiz7 lo tumbó con el argumento bueno:** *«mejor un aviso por reporte sin
// importar si ya se reportó, eso nos da más urgencia de estar listos y es buena alarma»*.
// Y tiene razón: que la gente SIGA cantando un sistema no es ruido — dice que aquello no ha
// terminado. El overlay está justo para molestar; suavizarlo era optimizar para lo contrario.
//
// Además resolvía un problema que él no tenía: el fallo reportado NO eran duplicados, sino que el
// overlay solo pintaba el aviso de UNA de las dos regiones. Ver [[koru-intel-dos-canales]].
